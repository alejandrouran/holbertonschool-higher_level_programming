...
class TestBase(unittest.TestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual(s3_1.__str__(), '[Rectangle] (1) 2/2 - 1/2')

        o3_2 = {'id': 2, 'size': 3, 'x': 4, 'y': 5}
        r3_1 = Square.create(**o3_2)
    ...
    def test_save_to_file(self):
        ...
        rsave = Rectangle.save_to_file([o5_1, 05_2])
        ...
        self.assertIsInstance(rlist[0], Square)
        self.assertIsInstance(rlist[1], Square)

        self.assertEqual(rlist[0].__str__(), '[Rectangle] (1) 2/8 - 10/7')
        self.assertEqual(rlist[0].__str__(), '[Rectangle] (2) 0/0 - 2/4')
